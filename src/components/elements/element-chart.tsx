...
const DoughnutChartWithoutInfo: React.FC = () => {
    ...
    return (
        <div className="col-lg-4">
            <h4 className="title title-sm text-center">Doughnut Chart Without Info</h4>
            <div>
    ...
    return (
      <div className="nk-block mgt-l">
        <div className="card bg-light">
          <p>
            Use a canvas tag with an <code>id="your-id"</code> in a place where you want to generate the chart
            <br />
            Then create an <code>ul</code> with a class <code>.chart-data</code> and give it an attribute{' '}
            <code>data-canvas="Your-id"</code> to link with the canvas.
            <br />
            Also, use <code>.d-none</code> class with <code>.chart-data</code> if you don't want to show this info in your page.
          </p>
          <p>
            Now for each data set you want to add on the chart, create a <code>li</code> , it takes 3 attributes{' '}
            <code>[data-color] , [data-title] , [data-amount]</code>
            <br />
            <code>[data-color]</code> takes a <code>hex , rgb , rgba</code> color value. Don't forget to add <code>#</code> with hex color.
          </p>
        </div>
      </div>
    );
