...
const teamMembers: TeamMember[] = coreTeamData;
...
const BlockCoreTeam = () => {
    ...
    return (
        <div className="nk-block">
            ...
            {/* Button */}
            <div className="text-center animated" data-animate="fadeInUp" data-delay=".5" style={{ visibility: "visible" }}>
                        ...
                        <div className="row align-items-start">
                            <div className="col-md-6">
                                <div className="team-photo">
                                    <Image src={selectedMember.image} alt={selectedMember.name} width={400} height={600} />
                                </div>
                            </div>
                            <div className="col-md-6">
                                            ...
                                            {selectedMember.skills.map((skill, index) => (
                                                <div className="progress-wrap" key={index}>
                                                    ...
                                                    <div className="progress-bar progress-bar-xs bg-black-10">
                                                        <div className="progress-percent bg-primary" style={{ width: `${skill.percent}%` }}></div>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
