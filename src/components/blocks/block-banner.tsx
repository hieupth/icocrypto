    ...
    const renderBannerContent = (banner: BannerData) => (
        <>
            ...
            <div className="cpn-action">
                {banner.buttonText && banner.buttonLink && <CustomButton variant={ColorStyle.Gradient}>{banner.buttonText}</CustomButton>}
                {banner.buttons && (
                        ...
                        <div className="row align-items-center justify-content-center">
                            {variant === "S2" && bannerData.imageSrc && (
                                <div className="col-lg-5 order-lg-last">
                                    <Image src={bannerData.imageSrc} alt={bannerData.imageAlt || "Banner image"} width={1000} height={638} />
                                </div>
                            )}
                            <div className={`col-lg-${variant === "S2" ? "7" : "12"} text-center text-lg-start`} style={{ marginTop: "5rem" }}>
                                <div
                                    className={`banner-caption cpn tc-light ${
                                        variant === "S1" ? "d-flex flex-column justify-content-center align-items-center" : ""
                                    }`}
